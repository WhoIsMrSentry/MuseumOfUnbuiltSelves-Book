...
function BookCard({ book, index, savedSlug }: { book: Book; index: number; savedSlug?: string }) {
  ...
  return (
    ...
    >
        {book.cover && (
          <div className="relative border-b border-white/5 px-4 pt-6">
            <div className="w-full">
              <div className="relative overflow-hidden rounded-md shadow-2xl transition-transform duration-700 group-hover:scale-105">
                <OptimizedImage
                  src={book.cover}
                  alt={book.title}
                  loading="lazy"
